...
})(self, function(__WEBPACK_EXTERNAL_MODULE__311__, __WEBPACK_EXTERNAL_MODULE__976__) {
...
/* harmony default export */ const component = ({
  ...
  watch: {
    ...
    modelValue(newValue) {
      ...
      if (!this.$refs.root || newValue === nullify(this.$refs.root.value)) return; // Make sure we have a flatpickr instance
